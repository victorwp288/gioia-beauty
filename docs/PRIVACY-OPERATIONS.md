...
| Sentry fixed surrogate events plus SDK envelope metadata                                          | `P4_PSEUDONYM`, `P5_DERIVED`                                                        | `RET-12`, `RET-15`    | Route/method, request UUID, environment/release, constant error, SDK/package versions, event/send IDs/timestamps. No original error/stack/request/user data.                   |
| PostHog personless route events plus SDK metadata                                                 | `P4_PSEUDONYM`, `P5_DERIVED`                                                        | `RET-12`, `RET-15`    | Fixed metric/request UUID plus SDK library/version/event UUID/timestamps/type. Preview EU sink; profiles/GeoIP/browser capture off. One-year retention misses 30-day proposal. |
...
| Vercel request/function logs; Sentry/PostHog monitoring                                 | Vercel `U1_UNKNOWN`; providers `P4_PSEUDONYM`/`P5_DERIVED`                 | `RET-12`, `RET-15`                     | Preview provider fields are registered above; Vercel inventory and provider expiry/deletion remain open. Production is unconfigured.                   |
