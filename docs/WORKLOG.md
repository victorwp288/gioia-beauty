...
**Verified/reconciled:** live pooler chains to the pinned Supabase Root 2021 CA; 169 test files/2,071 tests pass (2 files/4 tests skipped), SQL static validation, format, lint, typecheck, and production build pass. Independent review findings on exact psql output, interrupted-provision quiet time, migration sessions/memberships, and Local docs were fixed. Local gitleaks 8.30.1 remains unavailable; CI must run that gate.
