...
export const metadata = {
  title: "Privacy Policy - Gioia Beauty",
  description:
    "Informativa sulla privacy del centro estetico Gioia Beauty secondo il GDPR 679/2016. Trattamento dati personali e cookie policy.",
  ...
  return (
    <div className=" m-auto mt-24 w-[90vw] md:mt-32 md:w-[70vw]">
      ...
      <p className="text-sm">
        ...
        finalità ed i soggetti con cui i dati vengono condivisi, contatta il
        Titolare.
      </p>
      <br />
      <h2 className="font-bold text-lg">Titolare del Trattamento dei Dati</h2>
      <p className="text-sm">
        Gioia Beauty di Castignoli Gioia - via Emilia, 58- 29010, Roveleto di
        Cadeo, Piacenza (Italia) <br /> Partita IVA <b>01871820336</b> <br />
        Indirizzo email del Titolare: <b>gioiabeautyy@gmail.com</b>
      </p>
      <br />
      <h2 className="font-bold text-lg">Tiologie di dati raccolti</h2>
      <p className="text-sm">
        Il Titolare non fornisce una lista di tipologie di Dati Personali
        raccolti. Dettagli completi su ciascuna tipologia di Dati Personali
      ...
      <p className="text-sm">
        ...
        <br />È comunque sempre possibile richiedere al titolare di chiarire la
      ...
      <p className="text-sm">
        ...
        motivazione. Qualora gli Utenti si oppongano al trattamento per finalità
      ...
      <br />
      <h3 className="font-medium italic">Come esercitare i diritti</h3>
      <p className="text-sm">
      ...
      <br />
      <h3 className="font-medium italic">Modifiche a questa privacy policy</h3>
      <p className="text-sm">
