...
| --------------------------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `GET /api/health`           | Public uptime monitor                                   | No body or parsed input                                                                                                                                 | Constant `{ "status": "ok" }`; no environment, version, dependency, timestamp, request, or customer data                   | None; shallow process-liveness probe only                                                                       | None required; constant response performs no external I/O           | `private, no-store`; `X-Robots-Tag: noindex, nofollow` | 0 database/Auth/provider/network reads; 0 writes; 0 rows                                                                                                                                                                                            |
...
The health route proves only that the Next.js process can answer a request. It
deliberately does not inspect environment configuration, database, Auth,
provider, migrations, queues, or readiness, and must not be used as cutover or
restore evidence.
