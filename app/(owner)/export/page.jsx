        ...
        <div className="mb-8">
          <div className="mb-4">
            <button
              ...
              className="inline-flex items-center space-x-2 px-4 py-2 border-2 border-blue-500 rounded-md text-sm font-medium text-blue-600 bg-white hover:bg-blue-50 transition-colors shadow-xs"
              type="button"
            >
            ...
            <div className="flex-1 min-w-0">
              ...
              <form onSubmit={handleExport}>
                <div className="grid gap-4 sm:grid-cols-2 mb-5">
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    Data iniziale
                    <input
                      className="mt-2 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-xs focus:border-blue-500 focus:outline-hidden focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-900 dark:text-white"
              ...
              {exportStats ? (
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
                  ...
                  <div className="text-sm text-blue-700 dark:text-blue-400 space-y-1 wrap-break-word">
                    <p>
